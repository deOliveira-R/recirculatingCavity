...
# -*- coding: utf-8 -*-
"""
Created on Sat Feb 17 03:38:10 2018
...
print(trigsimp(-sin(x)*cos(y) - sin(x)*cos(y)))
print(trigsimp(sin(x)*cos(x)*cos(y)**2 + sin(x)*cos(x)*sin(y)**2))
